...
"""Recipe for training a speech emotion recognition system using discrete audio representations.
...
class SpeechEmotionRecognition(sb.Brain):
    ...
    def on_stage_end(self, stage, stage_loss, epoch=None):
        ...
        if stage == sb.Stage.TRAIN:
            ...
            stage_stats["ER"] = self.er_metric.summarize("average")
...
if __name__ == "__main__":
    ...
    brain = SpeechEmotionRecognition(
