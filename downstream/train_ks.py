...
"""Recipe for training an keyword spotting system based on audio tokens.

To run this recipe:
> python train_ks.py hparams/tasks/<config>.yaml hparams/codecs/<config>.yaml hparams/datasets/<config>.yaml
...
class KeywordSpotting(sb.Brain):
