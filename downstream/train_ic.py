...
"""Recipe for training an intent classification system based on audio tokens.

To run this recipe:
> python train_ic.py hparams/tasks/<config>.yaml hparams/codecs/<config>.yaml hparams/datasets/<config>.yaml
...
class IntentClassification(sb.Brain):
